...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("~1.2-b2", VersionRange(Version(1, 2, 0, pre="b2"), Version(1, 3, 0),
                                 True)),
        ("~0.3", VersionRange(Version(0, 3, 0), Version(0, 4, 0), True)),
        ("~3.5", VersionRange(Version(3, 5, 0), Version(3, 6, 0), True)),
        ("~=3.5", VersionRange(Version(3, 5, 0), Version(4, 0, 0), True)),
        ("~=3.5.3", VersionRange(Version(3, 5, 3), Version(3, 6, 0), True)),
        (
            "~=3.5.3rc1",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "^1.2.3-beta.2",
            VersionRange(Version(1, 2, 3, pre="beta.2"),
                         Version(2, 0, 0), True),
        ),

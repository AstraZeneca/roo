...
def test_allows_all(v003, v010, v080, v114, v123, v124, v140, v200, v234,
                    v250, v300):
...
def test_intersect(v114, v123, v124, v200, v250, v300):
    ...
    assert VersionRange(v123, v250).intersect(VersionRange(v200, v300)) == \
        VersionRange(v200, v250)
...
def test_union(v003, v010, v072, v080, v114, v123, v124, v130, v140, v200,
    ...
    result = VersionRange(v003, v114, include_max=True).union(
        VersionRange(v114, v200))
    assert result == VersionRange(v003, v200)

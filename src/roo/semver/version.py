...
class Version(VersionRange):
    ...
    @property
    def prerelease(self) -> List[Union[str, int]]:
        return self._prerelease

    @property
    def build(self) -> List[Union[str, int]]:
        return self._build
    ...
    def _normalize_prerelease(self, pre: str) -> Union[str, None]:
        if not pre:
            return None
    ...
    def _normalize_build(self, build: str) -> Union[str, None]:
        if not build:
            return None
    ...
    def _split_parts(self, text: str) -> List[Union[str, int]]:
        parts: List[Union[str, int]] = text.split(".")

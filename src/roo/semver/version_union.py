...
class VersionUnion(VersionConstraint):
    ...
    An instance of this will only be created if the version can't be
    represented as a non-compound value.
    """
    ...
    def of(cls, *ranges):
        ...
        # Only allow Versions and VersionRanges here so we can
        # more easily reason
        ...
        merged = []
        for constraint in flattened:
            # Merge this constraint with the previous one, but only if they
            # touch.
            if not merged or (
